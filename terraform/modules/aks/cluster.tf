...
#
#   tags = merge(
#     { Name = "${var.env}-assigned-identity" },
#     var.tags
#   )
#
#
...
resource "azurerm_kubernetes_cluster" "main" {
  ...
  default_node_pool {
    name                        = "${var.system_node_pool_name}${var.env}"
    ...
    temporary_name_for_rotation = "temp${var.env}"
  ...
  # identity {
  #   type = "UserAssigned"
  #   identity_ids = tolist([azurerm_user_assigned_identity.main.id])
  # }
