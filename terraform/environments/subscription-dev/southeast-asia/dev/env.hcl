...
locals {
  ...
  secrets = {
    ntucreadonlyPassword            = "{ _RANDOM_ = 18 }"
    ntucadminPassword               = "{ _RANDOM_ = 18 }"
    databaseMasterUsername          = "postgres"
    databaseMasterPassword          = "{ _RANDOM_ = 18 }"
    databaseMasterName              = "postgres"
    dumpuserServiceDatabaseUsername = "dumpuserservice"
    dumpuserServiceDatabasePassword = "{ _RANDOM_ = 18 }"
    dumpuserServiceDatabase         = "dumpuserservice_dev"
    jumpboxAgentUsername            = "jumpbox"
    jumpboxAgentPassword            = "{ _RANDOM_ = 18 }"
  }
}
