# ---------------------------------------------------------------------------------------------------------------------
# RUN TERRAGRUNT DESTROY-ALL, OUTPUT THE DESTROY TO THE TERMINAL AND TO A LOG FILE
# ---------------------------------------------------------------------------------------------------------------------
...
LOG_FILE_NAME=${1:-detroy-${ENVIRONMENT}.log}
...
terragrunt run-all destroy --terragrunt-non-interactive --terragrunt-include-external-dependencies 2>&1 | tee temp.log
